...
public sealed partial class PlayerTab : Control
{
    ...
    private int Compare(PlayerInfo x, PlayerInfo y)
    {
        ...
        return _headerClicked switch
        {
            ...
            Header.CCApproved => x.CombinedPermissions.HasFlag(AdditionalPermissionsTypes.CCSHC).CompareTo(y.CombinedPermissions.HasFlag(AdditionalPermissionsTypes.CCSHC)),  // Far Horizons
            _ => 1
        };
    }
